...
enum SERVICE_ID_t {
   ...
   */
	SERVICE_MAINTENANCE_START  = 0,
	SERVICE_MAINTENANCE_HEARTBEAT_ID = SERVICE_MAINTENANCE_START,
	SERVICE_MAINTENANCE_RTC_ID,
	SERVICE_MAINTENANCE_END    = 99,

  /**
   * Application Services
   */
	SERVICE_APPLICATION_START  = 100,
	SERVICE_APPLICATION_CLOCK_MANAGEMENT_ID = SERVICE_APPLICATION_START,
	...
	SERVICE_APPLICATION_END    = 199,

  /**
   * System Management Services
   */
	SERVICE_SYSTEM_MGMT_START  = 200,
	...
	SERVICE_SYSTEM_MGMT_END    = 299,

  /**
   * Power Services
   */
	SERVICE_POWER_START        = 300,
	SERVICE_POWER_STOP_MODE_REQ_ID = SERVICE_POWER_START,
	...
	SERVICE_POWER_SETTING_GET_REQ_ID,
	...
	SERVICE_POWER_END          = 399,

  /**
   * Cryptocell / Security Services
   */
	SERVICE_CRYPTOCELL_START   = 400,
	SERVICE_CRYPTOCELL_GET_RND =  SERVICE_CRYPTOCELL_START,
	...
	SERVICE_CRYPTOCELL_END     = 499,

  /**
   * Boot Services
   */
	SERVICE_BOOT_START         = 500,
	SERVICE_BOOT_PROCESS_TOC_ENTRY = SERVICE_BOOT_START,
	SERVICE_BOOT_CPU,
	SERVICE_BOOT_RELEASE_CPU,
	SERVICE_BOOT_RESET_CPU,
	SERVICE_BOOT_RESET_SOC,
	SERVICE_BOOT_SET_VTOR,
	SERVICE_BOOT_SET_ARGS,
	SERVICE_BOOT_END           = 599,

  /**
   * Update Services
   */
	SERVICE_UPDATE_START       = 600,
	SERVICE_UPDATE_STOC        = SERVICE_UPDATE_START,
	SERVICE_UPDATE_END         = 699,

  /**
   * Clocks Services
   */
	SERVICE_CLOCK_START        = 700,
